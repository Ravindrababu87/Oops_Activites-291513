    ...
    public static void main(String[] args) {
		...
		switch(chooice) {
		  case 1:
			...
			FourWheeler fobj = new FourWheeler(make, vehicalnumber, fuelType, fuelCapacity, cc , audioSystem, numberOfDoors);
		    break;
		  case 2:
          System.out.println("Kick Start Available(yes/no):");
          String kickStartAvailable = sc.next() ;

          TwoWheeler tobj = new TwoWheeler(make, vehicalnumber, fuelType, fuelCapacity, cc ,kickStartAvailable);
		    break;
		}
		sc.close();
	}    
